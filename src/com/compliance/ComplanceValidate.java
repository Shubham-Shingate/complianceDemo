...
public class ComplanceValidate {
	...
	public Boolean consigneeNameVerification(String consigneeNameBL, String consigneeNamePL,String ConsigneeNameCertiOfOrigin,String consigneeInvoice) 
	 {
		Boolean flag = false;
		 if(consigneeNameBL!=null && !consigneeNameBL.isEmpty() && consigneeNamePL!=null 
				 ...
				 && !consigneeInvoice.isEmpty() && consigneeInvoice!=null)
		 {
				if (consigneeNameBL.equalsIgnoreCase(consigneeNamePL) || consigneeNameBL.equalsIgnoreCase(ConsigneeNameCertiOfOrigin) || 
						consigneeNameBL.equalsIgnoreCase(consigneeInvoice) ) {
					flag  = true;
				}
		 }
		 else
