...
public class BlockList1 {
	...
	@JsonProperty("LineList1")
    private LineList1[] LineList1;
    ...
    public LineList1[] getLineList1 ()
    {
        return LineList1;
    }

    public void setLineList1 (LineList1[] LineList1)
    {
    ...
    {
        return "ClassPojo [BlockFGColor = "+BlockFGColor+", BlockWidth = "+BlockWidth+", Miscellaneous = "+Miscellaneous+", LineList1 = "+LineList1+", BlockType = "+BlockType+", BlockID = "+BlockID+", BlockStartY = "+BlockStartY+", BlockStartX = "+BlockStartX+", BlockBGColor = "+BlockBGColor+", BlockHeight = "+BlockHeight+", Remark = "+Remark+"]";
    }
}
