<%@page import="com.axis.compliance.TestCompliance"%>
...
<html lang="en">
 ...
 $(document).ready(function(){
   ...
   <div  onclick="openCity(event, 'UCP600')" class="dash-header"><b>Document Consistency Checker</b>  </div>
                                 <div class="table-responsive">
                                    <table id="myTable" class="display table table-bordered table-striped">
                                       ...
                                       <tbody>
                                          <%
                                          	System.out.println("arrComp Size :: "+arrComp.size());
   ...
   ArrayList<String> Pass_list=md.getStatusResult("1001", "true");
   int pass_count = Pass_list.size();
   ArrayList<String> Fail_list=md.getStatusResult("1001", "false");
